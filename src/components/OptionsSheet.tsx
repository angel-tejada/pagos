...
const makeStyles = (c: Palette) =>
  StyleSheet.create({
    ...
    grabber: { width: 40, height: 5, borderRadius: 3, backgroundColor: c.sheetLine, alignSelf: 'center', marginBottom: spacing.xl },
    ...
    rowBorder: { borderBottomWidth: 1, borderBottomColor: c.sheetLine },
    rowIcon: { width: 44, height: 44, borderRadius: radius.md, backgroundColor: c.sheetLine, alignItems: 'center', justifyContent: 'center' },
